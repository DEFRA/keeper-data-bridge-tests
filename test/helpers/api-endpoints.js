...
export const CLEANSE_DELETE_DATA_ENDPOINT = '/api/Cleanse/delete-data'
export const CLEANSE_DELETE_METADATA_ENDPOINT = '/api/Cleanse/delete-metadata'
export const CLEANSE_RUNS_ENDPOINT = '/api/Cleanse/runs'
export const CLEANSE_RUN_ENDPOINT = '/api/Cleanse/run/{operationId}'
export const CLEANSE_ISSUES_ENDPOINT = '/api/Cleanse/issues'
